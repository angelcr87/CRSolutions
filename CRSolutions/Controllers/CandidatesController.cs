...
namespace CRSolutions.Controllers
{
    public class CandidatesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("IdCantidate,FullName,EvaluatedPosition,IdRiskScore,EvaluationDate,ReportFile,AudioFile,PhotoFile,IdTypeTest,RecordEvaluation,BlackList,Status,IdUser,IdCompany")] Candidate candidate)
        {
